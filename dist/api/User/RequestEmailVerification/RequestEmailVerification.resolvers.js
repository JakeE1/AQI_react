...
var resolvers = {
    Mutation: {
        RequestEmailVerification: (0, resolversMiddleware_1.default)(function (_, __, _a) {
            var req = _a.req;
                ...
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        ...
                        case 3:
                            ...
                            return [4 /*yield*/, (0, sendEmail_1.sendVerificationEmail)(user.fullName, newVerification.key)];
                        case 4:
                            _b.sent();
                            return [2 /*return*/, {
                                    ok: true,
