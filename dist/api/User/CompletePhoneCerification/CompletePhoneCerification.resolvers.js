...
var resolvers = {
    Mutation: {
        CompletePhoneVerification: function (_, args) { return __awaiter(void 0, void 0, void 0, function () {
                ...
                switch (_a.label) {
                    ...
                    case 5:
                        ...
                        if (user) {
                            ...
                            user.save();
                            token = (0, createJWT_1.default)(user.id);
                            return [2 /*return*/, {
                                    ok: true,
                                    error: null,
                                    token: token
...
//# sourceMappingURL=CompletePhoneCerification.resolvers.js.map